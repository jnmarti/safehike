      ...
      <div className="flex-1 space-y-2">
        <div className="bg-green-50 border border-green-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-xs font-medium text-green-700">Thinking</span>
          ...
          {needsTruncation && (
            <button
              ...
              className="mt-3 flex items-center gap-1 text-xs font-medium text-green-600 hover:text-green-800 transition-colors"
            >
              {isExpanded ? (
                <>
                  <span>Show less</span>
